...
<html lang="en">
  ...
  <body>
    ...
    <form method="post" action="/predict-form">
      <label for="message">Enter text to analyze:</label><br>
      <textarea id="message" name="message" rows="6" cols="60"></textarea><br><br>
    ...
    {% if model_loaded %}
      <p>Model loaded from: {{ model_path }}</p>
    {% else %}
      <p style="color: red;">Model is not loaded on the server.</p>
    {% endif %}
  </body>
</html>
"""
